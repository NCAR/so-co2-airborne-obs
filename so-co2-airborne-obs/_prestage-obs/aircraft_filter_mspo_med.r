acfiltmspomed=function(readnew=F,filt=T){
...
# write out
write(names(hippomerge),'HIPPO_SO_mSPO_medusa.txt',ncol=ncol(hippomerge))
write(t(hippomerge),'HIPPO_SO_mSPO_medusa.txt',ncol=ncol(hippomerge),append=T)
...
# write out
write(names(orcasmerge),'ORCAS_SO_mSPO_medusa.txt',ncol=ncol(orcasmerge))
write(t(orcasmerge),'ORCAS_SO_mSPO_medusa.txt',ncol=ncol(orcasmerge),append=T)
...
# write out
write(names(atommerge),'ATOM_SO_mSPO_medusa.txt',ncol=ncol(atommerge))
write(t(atommerge),'ATOM_SO_mSPO_medusa.txt',ncol=ncol(atommerge),append=T)


} # end of acfiltmspomed function
